...
const Register = (props) => {
  ...
  useEffect(()=>{
    if(isAuthenticated){// after authenticated is true, we want to redirect to 'home' page
      props.history.push('/');
    }
  ...
  },[error,isAuthenticated,props.history]);//want this to execute when some error msg is added to the state.
  ...
  const onSubmit = e =>{
    ...
    register({//calling register function from AuthState.js
      name,
      email,
      password
    });
